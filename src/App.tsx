...
import { ADMINPAGE_PATH, AUTH_PATH, MAIN_PATH, MYPAGE_PATH, MY_REVIEWLIST_PATH, PROFILE_UPDATE_PATH, QNA_DETAIL_PATH, QNA_PATH, QNA_UPDATE_PATH, QNA_WRITE_PATH, REST_ADD_PATH, REST_DETAIL_PATH, REVIEW_DETAIL_PATH, REVIEW_PATH, REVIEW_UPDATE_PATH, REVIEW_WRITE_PATH, SCHEDULE_DETAIL_PATH, SCHEDULE_PATH, SCHEDULE_UPDATE_PATH, SCHEDULE_WRITE_PATH, SERVICE_PATH, SIGN_IN_ABSOLUTE_PATH, SIGN_IN_PATH, SIGN_UP_PATH, TOUR_ADD_PATH, TOUR_DETAIL_PATH, TOUR_PATH, USER_LIST_PATH } from './constant';
