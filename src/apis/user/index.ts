...
import {
    DELETE_ADMIN_USER_REQUEST_URL,
    DELETE_USER_REQUEST_URL,
    GET_SEARCH_USER_LIST_REQUEST_URL,
    GET_USER_LIST_REQUEST_URL,
    GET_USER_REQUEST_URL,
    PATCH_USER_INFO_REQUEST_URL,
    POST_USER_NICKNAME_REQUEST_URL,
} from "src/constant";
