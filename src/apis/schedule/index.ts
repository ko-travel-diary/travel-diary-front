...
export const deleteScheduleRequest = async (scheduleNumber: string | number, accessToken: string) => {
    const result = await axios
        .delete(DELETE_SCHEDULE_REQUEST_URL(scheduleNumber), bearerAuthorization(accessToken))
...
export const getScheduleDetailRequest = async (scheduleNumber: string | number, accessToken: string) => {
    const result = await axios
        .get(GET_SCHEDULE_REQUEST_URL(scheduleNumber), bearerAuthorization(accessToken))
