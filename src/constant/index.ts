...
export const REVIEW_DETAIL_ABSOLUTE_PATH = (reviewNumber: string | number) =>
    `${SERVICE_PATH}/${REVIEW_PATH}/${reviewNumber}`;
export const REVIEW_UPDATE_ABSOLUTE_PATH = (reviewNumber: string | number) =>
    `${SERVICE_PATH}/${REVIEW_PATH}/update/${reviewNumber}`;
...
export const SCHEDULE_DETAIL_ABSOLUTE_PATH = (
    scheduleNumber: string | number
) => `${SERVICE_PATH}/${MYPAGE_PATH}/${SCHEDULE_PATH}/${scheduleNumber}`;
export const SCHEDULE_UPDATE_ABSOLUTE_PATH = (
    scheduleNumber: string | number
...
export const ADMINPAGE_TOUR_CONTROL_ABSOLUTE_PATH = (
    tourAttractionsNumber: string | number
) => `${SERVICE_PATH}/${ADMINPAGE_PATH}/tourcontrol/${tourAttractionsNumber}`;
export const ADMINPAGE_REST_CONTROL_ABSOLUTE_PATH = (
    restaurantNumber: string | number
) => `${SERVICE_PATH}/${ADMINPAGE_PATH}/restcontrol/${restaurantNumber}`;

export const TOURATTRACTIONS_DETAIL_ABSOLUTE_PATH = (
    tourAttractionsNumber: string | number
) => {
    console.log(
        `${SERVICE_PATH}/${TOUR_PATH}/tourlist/${tourAttractionsNumber}`
    );
    return `${SERVICE_PATH}/${TOUR_PATH}/tourlist/${tourAttractionsNumber}`;
};
export const RESTAURANT_DETAIL_ABSOLUTE_PATH = (
    restaurantNumber: string | number
) => `${SERVICE_PATH}/${TOUR_PATH}/restlist/${restaurantNumber}`;
...
export const IMAGE_LOAD_URL = (imageUrl: string) =>
    `${SEVER_IMAGE_FILE_MODULE_URL}/file/${imageUrl}`;
...
export const POST_QNA_COMMENT_REQUEST_URL = (
    receptionNumber: number | string
) => `${SERVER_QNA_MODULE_URL}/${receptionNumber}/comment`;
...
export const GET_QNA_REQUEST_URL = (receptionNumber: number | string) =>
    `${SERVER_QNA_MODULE_URL}/list/${receptionNumber}`;
export const PATCH_QNA_REQUEST_URL = (receptionNumber: number | string) =>
    `${SERVER_QNA_MODULE_URL}/${receptionNumber}`;
export const PATCH_QNA_COMMENT_REQUEST_URL = (
    receptionNumber: number | string
) => `${SERVER_QNA_MODULE_URL}/${receptionNumber}/comment`;
export const DELETE_QNA_REQUEST_URL = (receptionNumber: number | string) =>
    `${SERVER_QNA_MODULE_URL}/${receptionNumber}`;
export const DELETE_QNA_COMMENT_REQUEST_URL = (
    receptionNumber: number | string
) => `${SERVER_QNA_MODULE_URL}/${receptionNumber}/comment`;
...
export const POST_REVIEW_COMMENT_REQUEST_URL = (
    reviewNumber: number | string
) => `${SERVER_REVIEW_MODULE_URL}/${reviewNumber}/comment`;
...
export const GET_COMMENT_LIST_REQUEST_URL = (reviewNumber: number | string) =>
    `${SERVER_REVIEW_MODULE_URL}/${reviewNumber}/comment/list`;
export const GET_REVIEW_REQUEST_URL = (reviewNumber: number | string) =>
    `${SERVER_REVIEW_MODULE_URL}/${reviewNumber}`;
export const GET_REVIEW_FAVORITE_STATUS_REQUEST_URL = (
    reviewNumber: number | string
) => `${SERVER_REVIEW_MODULE_URL}/${reviewNumber}/`;
export const PATCH_REVIEW_REQUEST_URL = (reviewNumber: number | string) =>
    `${SERVER_REVIEW_MODULE_URL}/${reviewNumber}`;
export const PATCH_REVIEW_COMMENT_REQUEST_URL = (
    commentNumber: number | string
) => `${SERVER_REVIEW_MODULE_URL}/comment/${commentNumber}`;
export const PATCH_INCREASE_VIEW_COUNT_REQUEST_URL = (
    reviewNumber: number | string
) => `${SERVER_REVIEW_MODULE_URL}/${reviewNumber}/view-count`;
export const PATCH_FAVORITE_COUNT_REQUEST_URL = (
    reviewNumber: number | string
) => `${SERVER_REVIEW_MODULE_URL}/${reviewNumber}/favorite`;
export const DELETE_REVIEW_REQUEST_URL = (reviewNumber: number | string) =>
    `${SERVER_REVIEW_MODULE_URL}/delete/${reviewNumber}`;
export const DELETE_REVIEW_COMMENT_REQUEST_URL = (
    commentNumber: number | string
) => `${SERVER_REVIEW_MODULE_URL}/comment/${commentNumber}`;
...
export const GET_SCHEDULE_REQUEST_URL = (scheduleNumber: number | string) =>
    `${SERVER_SCHEDULE_MODULE_URL}/${scheduleNumber}`;
export const PATCH_SCHEDULE_REQUEST_URL = (scheduleNumber: number | string) =>
    `${SERVER_SCHEDULE_MODULE_URL}/${scheduleNumber}`;
export const DELETE_SCHEDULE_REQUEST_URL = (scheduleNumber: number | string) =>
    `${SERVER_SCHEDULE_MODULE_URL}/${scheduleNumber}`;
...
export const GET_USER_INFO_REQUEST_URL = (userId: number | string) =>
    `${SERVER_USER_MODULE_URL}/${userId}`;
...
export const GET_TOURATTRACTIONS_REQUEST_URL = (
