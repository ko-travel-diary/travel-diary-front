...
export const TRAVEL_PATH = 'search';
...
export const SEARCH_ABSOULUTE_PATH = `${SERVICE_PATH}/${TRAVEL_PATH}`;
...
export const GET_QNA_URL = (receptionNumber: number | string) => `${SERVER_QNA_MODULE_URL}/${receptionNumber}`;
export const PUT_QNA_URL = (receptionNumber: number | string) => `${SERVER_QNA_MODULE_URL}/${receptionNumber}`;
export const DELETE_QNA_URL = (receptionNumber: number | string) => `${SERVER_QNA_MODULE_URL}/${receptionNumber}`;
...
export const GET_REVIEW_LIST_URL = `${SERVER_REVIEW_MODULE_URL}/list`;
export const GET_SEARCH_REVIEW_LIST_URL = `${SERVER_REVIEW_MODULE_URL}/list/search`;
export const GET_REVIEW_URL = (reviewNumber: number | string) => `${SERVER_REVIEW_MODULE_URL}/${reviewNumber}`;
export const PUT_REVIEW_URL = (reviewNumber: number | string) => `${SERVER_REVIEW_MODULE_URL}/${reviewNumber}`;
export const INCREASE_VIEW_COUNT_URL = (reviewNumber: number | string) => `${SERVER_REVIEW_MODULE_URL}/${reviewNumber}/view-count`;
export const INCREASE_FAVORITE_COUNT_URL = (reviewNumber: number | string) => `${SERVER_REVIEW_MODULE_URL}/${reviewNumber}/favorite`;
export const DELETE_REVIEW_URL = (reviewNumber: number | string) => `${SERVER_REVIEW_MODULE_URL}/${reviewNumber}`;
...
export const GET_SCHEDULE_LIST_URL = `${SERVER_SCHEDULE_MODULE_URL}/list`;
export const GET_SEARCH_SCHEDULE_LIST_URL = `${SERVER_SCHEDULE_MODULE_URL}/list/search`;
export const GET_SCHEDULE_URL = (scheduleNumber: number | string) => `${SERVER_SCHEDULE_MODULE_URL}/${scheduleNumber}`;
export const PUT_SCHEDULE_URL = (scheduleNumber: number | string) => `${SERVER_SCHEDULE_MODULE_URL}/${scheduleNumber}`;
export const DELETE_SCHEDULE_URL = (scheduleNumber: number | string) => `${SERVER_SCHEDULE_MODULE_URL}/${scheduleNumber}`;
...
export const GET_USER_LIST_URL = `${SERVER_USER_MODULE_URL}/userlist`;
export const GET_USER_INFO_URL = (userId: number | string) => `${SERVER_USER_MODULE_URL}/${userId}`;
export const PATCH_USER_INFO_URL = `${SERVER_USER_MODULE_URL}/edit`;
export const DELETE_USER_INFO_URL = `${SERVER_USER_MODULE_URL}/cancel-account`;
export const DELETE_ADMIN_USER_INFO_URL = `${GET_USER_LIST_URL}/cancel-account`;

export const SERVER_TOURATTRACTIONS_MODULE_URL = `${SERVER_API_URL}/tourattractions`;
export const GET_TOURATTRACTIONS_DATA_URL = (tourattractionsNumber: number | string) => `${SERVER_TOURATTRACTIONS_MODULE_URL}/tourlist/${tourattractionsNumber}`;
export const POST_TOURATTRACTIONS_DATA_URL = `${SERVER_TOURATTRACTIONS_MODULE_URL}/addTourAttractions`;

export const SERVER_RESTAURANT_MODULE_URL = `${SERVER_API_URL}/restaurant`;
export const GET_RESTAURANT_DATA_URL = (restaurantNumber: number | string) => `${SERVER_RESTAURANT_MODULE_URL}/restlist/${restaurantNumber}`;
export const POST_RESTAURANT_DATA_URL = `${SERVER_RESTAURANT_MODULE_URL}/addRestaurant`;
