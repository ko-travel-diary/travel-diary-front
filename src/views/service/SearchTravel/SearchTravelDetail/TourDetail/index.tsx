...
export default function TourDetail() {
    ...
    const getTourAttractionsResponse = (result: GetTourAttractionsResponseDto | ResponseDto | null) => {
        ...
        const { tourAttractionsImageUrl, tourAttractionsName, tourAttractionsLocation, tourAttractionsTelNumber, tourAttractionsHours, tourAttractionsOutline } = result as GetTourAttractionsResponseDto;
